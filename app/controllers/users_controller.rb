class UsersController < ApplicationController
  ...
  def destroy
    @user.destroy
    respond_to do |format|
      format.html { redirect_to users_url, notice: 'Seu Usuário foi removido com sucesso!' }
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :lastname, :email, :university, :gender, :profile, :age, :address)
    end
end
